                ...
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12 col-md-12">
                            ...
                            <div class="p-20">
                                <form action="{{ route('vehicles.update', $v->id) }}" data-parsley-validate novalidate  method="POST" >
                                {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('vehicle_type_id', $vehicle_types, $v->vehicle_type_id, ['class'=> 'form-control', 'id'=> 'vehicle_type_id', 'required' => 'required'] ) }}
                                    </div>

                                    <div class="form-group">
                                        <label for="model">Model<span class="text-danger"></span></label>
                                        <input type="text" name="model" parsley-trigger="change" value="{{ $v->model }}"
                                                placeholder="Enter model" class="form-control" id="model">
                                    </div>
                                    
                                    <div class="form-group">
                                        <label for="plaque">Plaque<span class="text-danger">*</span></label>
                                        <input type="text" name="plaque" parsley-trigger="change" required  value="{{ $v->plaque }}"
