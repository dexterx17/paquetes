                ...
                <div class="card-box">
                    ...
                    <div class="row">
                        <div class="col-sm-12 col-xs-12 col-md-12">
                            ...
                            <div class="p-20">
                                <form action="{{ route('vehicle_types.update',$type->id) }}" data-parsley-validate novalidate  method="POST" >
                                {{ csrf_field() }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="type" parsley-trigger="change" value="{{ $type->type }}"  required 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="cost_per_kilometer" parsley-trigger="change" required value="{{ $type->cost_per_kilometer }}" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="maintenance" parsley-trigger="change" required value="{{ $type->maintenance }}" 
